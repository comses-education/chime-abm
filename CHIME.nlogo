...
to-report save-county-evac-data
...
set evac-filename "exp-irma-20190828-Irma-evac-nointernet"</setup>
  ...
  <experiment name="osg_experiment_nocensus_factors" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="census-tract-max-pop">
      <value value="10000"/>
  ...
  <experiment name="osg_experiment_nocensus_factors2" repetitions="1" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <enumeratedValueSet variable="census-tract-max-pop">
      <value value="10000"/>
  ...
  <experiment name="osg_experiment_short" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3"/>
